...
class BoxWidget(ButtonBehavior, Image):
    ...
    def on_release(self):
        self.parent.make_scroll_view(self.rules, self.click_on_rule_function, str(id(self)) + str(self.rules))
    ...
    def click_on_rule_function(self, rule):
        ...
        playground.make_scroll_view(engine.get_all_rules(), lambda _: None, id(playground))